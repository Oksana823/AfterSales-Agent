...
public class ProductService {
    ...
    public ProductService(ProductRepository repository, ProductSearchService searchService, StringRedisTemplate redis, BusinessProperties properties, JsonService json) { this.repository = repository; this.searchService = searchService; this.redis = redis; this.properties = properties; this.json = json; }
