...
public class BusinessController {
    ...
    public BusinessController(OrderService orders, ProductService products, TicketService tickets) {
        this.orders = orders;
    ...
    @GetMapping("/users/{userId}/orders/latest")
    public Object latest(@PathVariable Long userId) {
        return orders.latestOrder(userId);
    }
    ...
    public Object ticket(@PathVariable Long id) {
        return tickets.get(id);
    }

    @GetMapping("/orders/{orderId}/tickets")
    public Object orderTickets(@PathVariable Long orderId) {
        return tickets.byOrder(orderId);
    }
}
