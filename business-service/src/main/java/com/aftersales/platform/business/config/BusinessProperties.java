...
public class BusinessProperties {
    ...
    public void setDelayedShipmentThresholdHours(int value) { this.delayedShipmentThresholdHours = value; }
    public long getRedisCacheSeconds() { return redisCacheSeconds; }
    public void setRedisCacheSeconds(long value) { this.redisCacheSeconds = value; }
    public String getElasticsearchIndexName() { return elasticsearchIndexName; }
    public void setElasticsearchIndexName(String value) { this.elasticsearchIndexName = value; }
    public String getElasticsearchUrl() { return elasticsearchUrl; }
    public void setElasticsearchUrl(String value) { this.elasticsearchUrl = value; }
}
