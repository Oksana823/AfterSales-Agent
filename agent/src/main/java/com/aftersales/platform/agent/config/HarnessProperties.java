...
public class HarnessProperties {
    ...
    public String getBusinessMcpUrl() { return businessMcpUrl; }
    public void setBusinessMcpUrl(String value) { this.businessMcpUrl = value; }
    public boolean isMcpClientEnabled() { return mcpClientEnabled; }
    public void setMcpClientEnabled(boolean value) { this.mcpClientEnabled = value; }
    public int getMcpRequestTimeoutSeconds() { return mcpRequestTimeoutSeconds; }
    public void setMcpRequestTimeoutSeconds(int value) { this.mcpRequestTimeoutSeconds = value; }
    public int getMaxToolCalls() { return maxToolCalls; }
    public void setMaxToolCalls(int value) { this.maxToolCalls = value; }
