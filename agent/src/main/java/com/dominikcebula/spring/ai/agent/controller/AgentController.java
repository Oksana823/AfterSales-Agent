package com.dominikcebula.spring.ai.agent.controller;

import com.dominikcebula.spring.ai.agent.service.AgentOrchestrator;
import com.dominikcebula.spring.ai.agent.service.ApprovalService;
...
public class AgentController {
    ...
    public AgentController(AgentOrchestrator orchestrator, TraceService trace,
                           ApprovalService approvals, ProductService products) {
    ...
    @PostMapping("/products/index/rebuild")
    public Object rebuildProductIndex() {
        products.rebuildIndex();
